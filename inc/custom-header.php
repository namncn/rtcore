 ...
 *
 * @uses rt_header_style()
 */
function rt_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'rt_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '424242',
		'width'                  => 1200,
		'height'                 => 138,
		'flex-height'            => true,
		'wp-head-callback'       => 'rt_header_style',
	) ) );
}
